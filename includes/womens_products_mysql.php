...
$result = $conn->query("SELECT product_name, product_price, product_desc, product_short_desc, product_img, product_gender, product_id, product_category FROM products WHERE product_gender = 'Female' ");
